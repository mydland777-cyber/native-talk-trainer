    ...
    return [
      ...
      },
      {
        ...
        explanation: [
          ...
          "casual は 한 잔만 주세요 にして、少し会話っぽく軽い響きにした",
          "カタカナは聞こえ方の大まかな目安として見るのがおすすめ",
        ],
      },
    ];
  }
  ...
  if (language === "chinese") {
    return [
      ...
      },
      {
        ...
        casualKana: "ライベイ ビン ナーティエ シエシエ",
        explanation: [
          "请给我... は丁寧で、店員さん相手にも使いやすい形",
          "我想要... は少し自然な会話寄りで、注文でもよく使う",
          "casual は 来杯... にして、より口語的でサッと言う感じにした",
